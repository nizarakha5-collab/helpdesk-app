...
<a href="{{ route('agent.reports') }}" class="menu-item {{ request()->routeIs('agent.reports') ? 'active' : '' }}">
    ...
    <span>Rapports</span>
        ...
        <nav class="menu">
            <a href="{{ route('agent.notifications') }}" class="menu-item active">
                <span class="menu-icon">🔔</span>
    ...
    <main class="main">
        <header class="topbar">
            <div class="topbar-title">Notifications agent</div>
        ...
        <section class="content">
            <div class="page-card">
                ...
                <p class="page-text">
                    Consultez ici les nouveaux tickets et les réponses des utilisateurs.
                </p>
            </div>
            ...
            <div class="toolbar">
                ...
                @if ($unreadCount > 0)
                    <form method="POST" action="{{ route('agent.notifications.readAll') }}">
                        @csrf
                    ...
                    @foreach ($notifications as $notification)
                        <div class="notification-item {{ !$notification->is_read ? 'unread' : '' }}">
                            ...
                            <div class="notification-actions">
                                @if (!$notification->is_read)
                                    <form method="POST" action="{{ route('agent.notifications.read', $notification->id) }}">
                                        @csrf
                                ...
                                @if ($notification->ticket_id)
                                    <a href="{{ route('agent.tickets.show', $notification->ticket_id) }}" class="notification-link">
                                        Voir le ticket
                                    </a>
                                @endif
                            </div>
